...
os.chdir('C:\\Users\\mgvai\\Desktop\\TESTMODEL')
...
DATASTOCKS = pd.DataFrame(columns=Columns)
...
for i in range(N):
    ...
    DATASTOCKS = DATASTOCKS.append(pd.DataFrame([[ticker, name, industry, subind]],
                                            columns=Columns))
DATASTOCKS.iloc[0:3,:]
len(DATASTOCKS)
DATASTOCKS.to_csv('S&P500.csv',encoding='utf-8')
